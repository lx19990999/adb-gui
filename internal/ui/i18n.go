...
func (i *I18n) initTranslations() {
	...
	i.strings[Chinese] = map[string]string{
		...
		"confirm_delete":                 "确认删除",
		"confirm_delete_message":         "确定要删除选中的 %d 个文件/目录吗？此操作不可撤销。",
	...
	i.strings[English] = map[string]string{
		...
		"confirm_delete_message":         "Are you sure you want to delete the selected %d files/directories? This action cannot be undone.",
